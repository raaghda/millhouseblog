...
<div class="sidebar">
    ...
    <ul>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=01">Januari</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=02">Februari</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=03">Mars</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=04">April</a>
            
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=05">Maj</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=06">Juni</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=07">Juli</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=08">Augusti</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=09">September</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=10">Oktober</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=11">November</a>
        </li>
        <li>
            <a href="/millhouseblog/www/?page=displaymonth&month=12">December</a>
        </li>
    </ul>
